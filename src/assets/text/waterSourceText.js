export default {
    waterSourceText: {
       ...
       paragraph1: "Beverage-bottling facilities get water through public supply (water withdrawn by a water supplier and delivered to many users; USGS, 2019) or self-supply (water withdrawn from a private source for private use; USGS, 2019). In each case, the water can be sourced from several different pools of the water cycle, like groundwater, surface water, or springs.",
