    ...
    <div id="grid-container-source">
      ...
      <div id="grid-container-illustration">
        ...
        <div class="text-container">
          <p>
            Water source data are not readily available for most bottling facilities. THIS IS A TEST. et al. 2023 performed new mapping analyses to infer where facilities source their water from. These analyses make some assumptions, like assuming that a facility near a well uses that well to source their water, and a facility within a public-supply zone uses public-supply water. Though imperfect, these estimates improve our understanding of where bottling facilities are sourcing their water. The charts below show the primary sources of bottled water in each state. 
          </p>
        </div>
      </div>
      <div
