...
p3_targets <- list(
  ...
  tar_target(p3_source_category_order_reduce,
             c('self supply', 'combination', 'public supply')),
  tar_target(p3_supply_colors_reduce,
             {
               supply_colors <- c('#213958', '#9b9560', '#ffe066')
               names(supply_colors) <- p3_source_category_order_reduce
               return(supply_colors)
             }),
  tar_target(p3_source_perc_bottled_water_facet_map_png,
             generate_bw_conus_map(site = p2_inventory_sites_sf_CONUS,
                                       ...
                                       proj_str = p1_proj,
                                       get_percent = TRUE,
                                       supply_colors = p3_supply_colors_reduce,
                                       width = 16, height = 9,
                                       bkgd_color = 'white',
                                       text_color = 'black',
                                       font_legend = p3_font_legend,
                                       outfile_template = '3_visualize/out/map_perc_bottled_water_map.png',
                                       dpi = 300),
             format = 'file'),
  tar_target(p3_source_count_bottled_water_facet_map_png,
             generate_bw_conus_map(site = p2_inventory_sites_sf_CONUS,
                                       ...
                                       text_color = 'black',
                                       font_legend = p3_font_legend,
                                       outfile_template = '3_visualize/out/map_count_bottled_water_map.png',
                                       dpi = 300),
             format = 'file'),
