...
p3_targets <- list(
  ...
  tar_target(p3_sites_map_conus_FY21,
             map_sites(sites = filter(p2_inventory_sites_sf_CONUS, FY_Entered == 2021),
                       states = p2_conus_sf, 
                       site_size = 1.1,
                       fill_by_type = FALSE,
  ...
  tar_target(p3_sites_map_conus_FY22,
             map_sites(sites = filter(p2_inventory_sites_sf_CONUS, FY_Entered == 2022),
                       states = p2_conus_sf, 
                       site_size = 1.1,
                       fill_by_type = FALSE,
                       site_fill_colors = p3_sites_map_params$site_fill_colors, 
  ...
  tar_target(p3_sites_map_conus_fy_comparison,
             combine_conus_maps(map1 = p3_sites_map_conus_FY21, 
                                map2 = p3_sites_map_conus_FY22, 
  ...
  tar_target(p3_sites_map_conus_fy_comparison_png,
             save_figure(figure = p3_sites_map_conus_fy_comparison, 
                         outfile = '3_visualize/out/sites_map_conus_fy_comparison.png', 
  ...
  tar_target(p3_sites_map_shifted_FY21,
             map_sites(sites = filter(p3_inventory_sites_shifted, FY_Entered == 2021),
                       states = p3_spatial_shifted,
                       site_size = p3_sites_map_params$site_size,
                       fill_by_type = FALSE,
                       site_fill_colors = p3_sites_map_params$site_fill_colors, 
  ...
  tar_target(p3_sites_map_shifted_FY21_png,
             save_figure(figure = p3_sites_map_shifted_annotated_FY21, 
                         outfile = '3_visualize/out/sites_map_national_shifted_FY21.png', 
                         bkgd_color = "#ffffff", width=16, height=9, dpi=300),
             format = 'file'),
  
  tar_target(p3_sites_map_shifted_FY22,
             map_sites(sites = filter(p3_inventory_sites_shifted, FY_Entered == 2022),
                       states = p3_spatial_shifted,
                       site_size = p3_sites_map_params$site_size,
                       fill_by_type = FALSE,
                       site_fill_colors = p3_sites_map_params$site_fill_colors, 
  ...
  tar_target(p3_sites_map_shifted_FY22_png,
             save_figure(p3_sites_map_shifted_annotated_FY22, 
                         outfile = '3_visualize/out/sites_map_national_shifted_FY22.png', 
                         bkgd_color = "#ffffff", width=16, height=9, dpi=300),
             format = 'file'),
  
  tar_target(p3_sites_map_shifted_FY23,
             map_sites(sites = filter(p3_inventory_sites_shifted, FY_Entered == 2023),
                       states = p3_spatial_shifted,
                       site_size = p3_sites_map_params$site_size,
                       fill_by_type = FALSE,
                       site_fill_colors = p3_sites_map_params$site_fill_colors, 
  ...
  tar_target(p3_sites_map_shifted_FY23_png,
             save_figure(figure = p3_sites_map_shifted_annotated_FY23, 
                         outfile = '3_visualize/out/sites_map_national_shifted_FY23.png', 
                         bkgd_color = "#ffffff", width=16, height=9, dpi=300),
             format = 'file'),
  
  tar_target(p3_sites_map_shifted_fy_comparison,
             combine_two_images(image_1_file = p3_sites_map_shifted_FY21_png, 
                                image_2_file = p3_sites_map_shifted_png, 
                                image_1_title = 'FY21', image_2_title = 'Current', 
                                width = 16, height = 6, bkgd_color = 'white')),
  
  tar_target(p3_sites_map_shifted_fy_comparison_png,
             save_figure(figure = p3_sites_map_shifted_fy_comparison, 
                         outfile = '3_visualize/out/sites_map_shifted_fy_comparison.png', 
